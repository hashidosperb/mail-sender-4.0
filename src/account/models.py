...
class SmsClient(models.Model):
    ...
    paid_sms_count = models.PositiveIntegerField(default=0)
    unpaid_sms_count = models.PositiveIntegerField(default=0)
    total_sms_count = models.PositiveIntegerField(default=0)
    class Meta:
