...
# Monkeypatch to bypass database version checks (e.g., PostgreSQL 10.21 on production server)
from django.db.backends.base.base import BaseDatabaseWrapper
BaseDatabaseWrapper.check_database_version_supported = lambda self: None

# Monkeypatch to fix Python 3.14 compatibility with Django template contexts copy
